#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Muhammad Umar
...
\033[1;96m░░░██║░░░███████╗╚█████╔╝██║░░██║██╗
\033[1;96m░░░╚═╝░░░╚══════╝░╚════╝░╚═╝░░╚═╝╚═╝
\033[1;96m«-----------------\033[1;91mUmerTech\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  Om Tech
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  Muhammad Umar
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 03157691248
\033[1;96m«-----------------\033[1;91mUmer__Tech\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
B = '\033[1;94m'
...
def mafia():
	...
	if black =="":
		...
		clear()
	        ...
	        os.system("cd $HOME && git clone https://github.com/nwaz1996/umerkhan")
                print (logo)
	        love("\033[1;93mTool User Name :\033[1;95m     OM ")
                love("\033[1;93mTool Password  :\033[1;95m     OM ")
                time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/nwaz1996/blackhole")
                print (logo)
	        love("\033[1;93mTool User Name :\033[1;95m     Umer ")
                love("\033[1;93mTool Password  :\033[1;95m     Tech ")
	        ...
	        os.system("cd $HOME && git clone https://github.com/nwaz1996/Spider")
                print (logo)
		...
		os.system("cd $HOME && git clone https://github.com/nwaz1996/KaliIndia")
                print (logo)
		love("\033[1;96mCongratulations UmerTech Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		love("\033[1;93mTool User Name India Password OM")
                time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/UmerTech/BlackHat")
                print (logo)
		love("\033[1;96mCongratulations BlackHat Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		love("\033[1;93mTool User Name BlackHat Password OM")
                time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/UmerTech/RedMoonNew")
                print (logo)
	        love("\033[1;91mCongratulations RedMoonNew Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name\033[1;92m RedMoonNew\033[1;93m Password \033[1;92mOM")
                time.sleep(6)
		...
		os.system("cd $HOME && git clone https://github.com/UmerTech/lov3Hak3r")
                print (logo)
		love("\033[1;96mCongratulations UmerTech Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/UmerTech/Cobra")
                print (logo)
	        love("\033[1;93mCongratulations Cobra Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;95mTool User Name Cobra  Password OM")
                time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/UmerTech/Dragon")
                print (logo)
	        love("\033[1;91mCongratulations Dragon Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;96mTool User Name Dragon  Password OM")
                time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/UmerTech/NetHunting")
                print (logo)
		love("\033[1;96mCongratulations NetHunting Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
                love("\033[1;92mTool User Name linux Password OM")
		time.sleep(5)
	        ...
	        os.system("rm -rf $HOME/Umer_Tech")
	        os.system("cd $HOME && git clone https://github.com/UmerTech/Umer_Khan")
                print (logo)
	        love("\033[1;93mCongratulations Umer_Tech Payload Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                time.sleep(5)
                os.system("cd $HOME/Umer_Tech && python3 Black_Mafia.py")
	elif black =="12":
	        clear()
		print(logo)
		os.system("rm -rf $HOME/Pak")
		os.system("cd $HOME && git clone https://github.com/umertech/Pak")
                print (logo)
		...
		os.system("rm -rf $HOME/Compile")
	        os.system("cd $HOME && git clone https://github.com/umertech/Compile")
                print (logo)
	        ...
	        os.system("cd $HOME && git clone https://github.com/umertech/Insta")
                print (logo)
	        love("\033[1;93mCongratulations  Tool Has Been Update Successfully")
	        love("Now you can open this tool as usual")
	        ...
	        os.system("cd $HOME && git clone https://github.com/umertech/TimePass")
                print (logo)
	        love("\033[1;93mCongratulations  Tool Has Been Update Successfully")
	        love("Now you can open this tool as usual")
                time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/umertech/GmailAttack")
                print (logo)
		...
		os.system("cd $HOME && git clone https://github.com/umerkhan/World")
                print (logo)
		love("\033[1;96mCongratulations umertech Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
		...
		print(logo)
		os.system("rm -rf $HOME/World")
		os.system("cd $HOME && git clone https://github.com/umertech/World")
                print (logo)
		love("\033[1;96mCongratulations UmerTech Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
                love("Passwordlist No1 (wordlist.txt) No2 (BlackMafia.txt)")
		time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/umertech/Testing")
                print (logo)
